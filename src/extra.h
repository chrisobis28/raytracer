...
Vertex applyTransform(const Vertex& vertex, const Transform& transform, float time);
void drawTransform(const Transform& transform, const glm::vec3& point, float time);
