...
struct Scene {
    ...
    std::shared_ptr<Image> images[6] = { std::make_shared<Image>(DATA_DIR "posx.jpg"), std::make_shared<Image>(DATA_DIR "negx.jpg"),
        std::make_shared<Image>(DATA_DIR "posy.jpg"), std::make_shared<Image> (DATA_DIR "negy.jpg"),
        std::make_shared<Image>(DATA_DIR "posz.jpg"), std::make_shared<Image> (DATA_DIR "negz.jpg") };
